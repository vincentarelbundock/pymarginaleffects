...
```
    ...
    Time:                        10:55:04   Log-Likelihood:                -66.158
...
```
    ...
    |-------|------|----------|-----------|---|------|-----------|--------------|--------------|
    | 0.0   | hp   | +1       | -0.036906 | … | 4.0  | 22.488569 | 22.507022    | 22.470117    |
    | 1.0   | hp   | +1       | -0.028689 | … | 4.0  | 20.801859 | 20.816203    | 20.787514    |
    | 2.0   | hp   | +1       | -0.046572 | … | 1.0  | 25.264652 | 25.287938    | 25.241366    |
    | 3.0   | hp   | +1       | -0.042271 | … | 1.0  | 20.255493 | 20.276628    | 20.234357    |
    | 4.0   | hp   | +1       | -0.039018 | … | 2.0  | 16.997817 | 17.017326    | 16.978308    |
...
```
    ...
    |-------|-----------|-----------|-----------|---|----------|-----|------|------|
    | 0     | 12.448705 | 1.802922  | 6.904737  | … | 17.84875 | 0   | 3    | 4    |
    | 1     | 21.031654 | 2.396346  | 8.776551  | … | 17.84875 | 0   | 3    | 4    |
    | 2     | 7.682197  | 6.189498  | 1.241166  | … | 17.84875 | 0   | 3    | 4    |
    | 3     | 24.73073  | 3.934364  | 6.285827  | … | 17.84875 | 0   | 3    | 4    |
...
```
    ...
    | 0.0 | hp   | +1                | -0.034264 | … | 0.040993 | 4.608461 | -0.067005  | -0.001522 |
...
```
    ...
    | rowid | term | contrast | estimate  | … | carb | predicted | predicted_lo | predicted_hi |
    |-------|------|----------|-----------|---|------|-----------|--------------|--------------|
    | 0.0   | drat | +1       | 10.241374 | … | 2.0  | 25.71863  | 20.597943    | 30.839317    |
    | 1.0   | drat | +1       | 5.223926  | … | 2.0  | 16.275658 | 13.663695    | 18.887621    |
