...
`hypothesis`: (str, int, float, list of strings, numpy array) Specifies a hypothesis test or custom contrast
...
- list: List of strings, with each string following the same logic as a single string argument. e.g.
    * `["b1 - b0 = 0", "b2 = 1", "b2 - b0 = 0"]` 
