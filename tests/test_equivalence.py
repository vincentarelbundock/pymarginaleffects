...
def test_simple_equivalence():
    ...
    assert_series_equal(cmp_r["statistic.nonsup"], cmp_py["statistic_nonsup"], check_names = False, rtol = 1e-3)
    assert_series_equal(cmp_r["p.value.nonsup"], cmp_py["p_value_nonsup"], check_names = False, rtol = 1e-4)
    assert_series_equal(cmp_r["statistic.noninf"], cmp_py["statistic_noninf"], check_names = False, rtol = 1e-3)
