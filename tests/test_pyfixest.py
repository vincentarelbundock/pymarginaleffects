...
def test_bare_minimum():
    ...
    assert_series_equal(p["estimate"], pl.Series([0.0104466614683 ]), check_names=False, rtol=rtol)
    ...
    if False:
        ...
        assert_series_equal(p3["estimate"], pl.Series([0.01044666147 ]), check_names=False, rtol=rtol)
        ...
        known = pl.Series([0.01222839154, 0.01222839154, 0.06484658716, 0.13887504383 , -0.11390247943, -0.26667151028])
...
def test_bare_minimum_fepois():
    ...
    assert_series_equal(p1["estimate"], pl.Series([1.02079513338]), check_names=False, rtol=rtol)
